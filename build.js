    ...
    const result = await terser.minify(js, {
      ...
      mangle: {
        ...
        reserved: [
          ...
          "openEditResearchItem",
          "saveResearchItemEdit",
          "_researchInsertTemplate",
          ...
          "openGuidelinesAnalyze",
          "analyzeThisGuideline",
          "selectGuidelineAnalysis",
          "deleteGuidelineAnalysis",
          "openCreateMasterAnalysis",
          "runCreateMaster",
          "openGAVersionHistory",
          "restoreGAVersion",
          "deleteGAVersion",
          "openGADiff",
          "_gaStartLabelEdit",
          "_gaSaveLabel",
          "_gaSaveAnalysisLabel",
          "_openGACompareModal",
          "loadEvaluation",
          "switchEvalTab",
          "openNewCriterion",
          ...
          "evaluateCandidate",
          "exportScorecardMarkdown",
          "_evalDeleteCriterion",
          "_evalDeleteCandidate",
          "openPromptLibrary",
          "closePromptLibrary",
          ...
          "deleteWorkingDoc",
          "renameWorkingDoc",
          "openWritingStyleModal",
          "analyzeWritingStyle",
          "saveWritingStyle",
          "clearWritingStyleProfile",
        ],
      },
      format: {
        comments: false,
